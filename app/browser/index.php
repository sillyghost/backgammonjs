  ...
  <tr>
    <td height="100%" valign="middle">
      ...
      <div class="container-fluid">
        <div class="row">
          <h1 class="text-center">Backgammon<br><small>Backgammon Multiplayer!</small></h1>
          <div class="container-fluid">
            <div class="row">
            ...
            <div class="row">
              <div class="col col-ts-12 col-xs-6 text-right">
                <button id="btn-play-random" class="btn btn-primary btn-lg"><span class="glyphicon glyphicon-refresh" aria-hidden="true"></span>Play</button>
              </div>
              <div class="col col-ts-12 col-xs-6 text-left">
                <button id="btn-exit" onclick="window.location.href = 'https://mrdigicoin.io';" class="btn btn-default btn-lg"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>Exit</button>
              </div>
            </div>
          </div>
        </div>
